...
// export default function codeForReset(props) {
//   const [code, setCode] = useState("");

  
    

//     // fetch(api + "/login/codeForReset", {
//     //   method: "POST",
//     //   headers: {
...
//           <label className="block font-bold font-sans-pro text-grey-700 text-2xl rounded font-bold md:text-center mb-1 md:mb-6 pr-4" for="inline-full-name">Enter the code</label>
