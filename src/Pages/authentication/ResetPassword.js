    ...
    <div className="flex items-center justify-center w-full  h-full md:mt-0 mt-6 ">
      <div className="w-full max-w-md">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <label className="block font-bold font-sans-pro text-grey-700 text-2xl rounded font-bold text-center mb-6 pr-4" for="inline-full-name">Choose a new password</label>
          {/*  NEW PASSWORD  */}
